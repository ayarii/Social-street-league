...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(html_email_template_name='password_reset/password_reset_email.html',template_name='password_reset/password_reset_form.html'), name='password_reset'),
